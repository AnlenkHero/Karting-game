...
namespace Kart.Project_Files.Scripts.Helpers
{
    ...
    {
        private Dictionary<NetworkObjectTypeId, FusionObjectPool> _poolsByPrefab =
            new Dictionary<NetworkObjectTypeId, FusionObjectPool>();
        ...
        public void ClearPool(NetworkObject prefab)
        {
            ...
            {
                pool.Clear();
                _poolsByPrefab.Remove(prefab.NetworkTypeId);
            }
        }
