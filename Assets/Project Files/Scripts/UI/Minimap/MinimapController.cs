...
public class MinimapController : MonoBehaviour
{
    ...
    [SerializeField] Vector2 fullScreenDimensions = new (1000, 1000);
    [SerializeField] Vector2 worldMin = new (-230f, -830f);
    ...
    Dictionary<MinimapWorldObject, MinimapIcon> miniMapWorldObjectsLookup = new ();
    private void Awake()
    {
        Instance = this;
    ...
    public void RegisterMinimapWorldObject(MinimapWorldObject miniMapWorldObject, bool followObject = false)
    {
        ...
        minimapIcon.transform.SetParent(contentRectTransform);
        minimapIcon.NameText.text = miniMapWorldObject.NameText;
